...
<body>
        ...
        foreach($commandes as $commande){
                echo "<div onclick=\"location.href='detailCommande.php?idCommande=".$commande['idCommande']."'\"> Référence : ".$commande['idCommande']."<br/>Etat : ".$commande['etat']."<br/>Date :".$commande['dateCommande']." </div>";
        }
                ?>
